...
namespace DocumentationApp.Controllers
{
    public class TestController : Controller
    {
        ...
        public TestController(ApplicationDbContext context, IWebHostEnvironment hostEnvironment, ICompositeViewEngine compositeViewEngine, IConfiguration config, UserManager<IdentityUser> userManager)
        {
            this.config = config;
            _context = context;
